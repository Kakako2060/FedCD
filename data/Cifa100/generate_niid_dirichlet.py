from torchvision.datasets import CIFAR100  # 导入 CIFAR100 数据集
...
def main():
    ...
    parser.add_argument("--n_class", type=int, default=100, help="number of classification labels")  # 修改为 100
