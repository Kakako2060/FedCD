...
if __name__ == "__main__":
    ...
    parser.add_argument("--algorithms", type=str, default="FedCD", help='algorithm names separate by comma')
    ...
    plot_train_loss(args, algorithms)
    plot_loss_comparison(args, algorithms)
